...
:usage
echo.
echo Usage: %~n0 [vc71 ^| vc80 ^| vc90 ^| vc100 ^| vc110 ^| vc140 ^| vc150 ^| vc160] [-x86 ^| -x64] [--reset]
echo.
echo e.g.   %~n0 vc71     (implies -x86)
echo        %~n0 vc80-x86
echo        %~n0 vc80-x64 --reset
echo.
echo Note: vc71=vs2003, vc80=vs2005, vc90=vs2008, vc100=vs2010, vc110=vs2012, vc140=vs2015, vc150=vs2017, vc160=vs2019
goto :eof
